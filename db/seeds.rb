...
Notebook.find_or_create_by(name: 'test', description: 'this...is a test....test.....test....test', color_hex: 'cccccc')
noteymcnotersen = Notebook.find_or_create_by(name: 'Another Notebranched', description: 'Where we keep notes and junk', color_hex: '333333')
